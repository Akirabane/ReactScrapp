// Require puppeteer -> API qui créer un navigateur chromium pour le webscrapping
const puppeteer = require ('puppeteer');
const fs = require('fs');
// require prompt pour les input de console VSCode / serveur
// Si vous avez pas prompt -> npm install prompt (idiot du village)
const prompt = require('prompt');

// On démarre l'app en NodeJS
prompt.start();
//Choix de l'utilisateur
console.log("Case 1 : Cinema");

//L'app se charge de prendre les infos du site (essaye avec les année de 2000 à 2021)
                    ...
                    (async() => {
                        ...
                        const movies = await page.evaluate(() => {
                            ...
                            for (element of elements) {
                                // je push dans un array (ci-dessus) les infos intéréssantes et je les garde en objet type JSON -> [{ Objet 1 => Valeur, Objet 2 => Valeur, etc...}]
                                movies.push({
